...
if ($_SESSION['rang'] !== 'developpeur' && $_SESSION['rang'] !== 'commercial') {
...
$opt = [
    ...
    $stmt = $pdo->prepare('SELECT * FROM missions WHERE etat = :etat');
    $stmt->execute(['etat' => 'en cours']);
